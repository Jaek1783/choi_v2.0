...
const Prograss = (props)=>{
    ...
    return(
        <Container>
            <PrograssBar count={props.count} isPc={isPc} scrollY={props.scrollY}>
            <div></div>
...
div{
    ...
    // width:${props=>(props.y/3457)*100 | (props.count*2)*10}%;
    width:${props=> props.scrollY/3457 | (props.count*2)*10 }%;
    height:10px;
...
span.rocket{
    display:${props=>props.count === 5 ? "none":"block" | props.y/3457*100 > 95 ? "none":"block"};
    img{
...
span.earth{
    display:${props=>props.count === 5 ? "flex":"none"| props.y/3457*100 >95 ? "flex":"none"};
